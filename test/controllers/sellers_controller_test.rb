...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { name: @seller.name, order_response: @seller.order_response } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { name: @seller.name, order_response: @seller.order_response } }
